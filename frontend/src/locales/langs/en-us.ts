  ...
  page: {
    ...
    manage: {
      ...
      merchant: {
        ...
        resetSecretConfirm: 'The old secret will be invalidated immediately and the new one is shown only once. Continue?',
        secretResultTitle: 'Merchant Credentials (shown only once)',
        secretOnceWarning: 'Copy and save the AppSecret now. It cannot be viewed again after closing. Use "Reset Secret" to rotate.',
        copy: 'Copy',
